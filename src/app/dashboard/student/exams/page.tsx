    ...
    <DashboardShell allowedRoles={["STUDENT"]}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-brand-ink/60 dark:text-brand-paper/60">Your exam results and grades.</p>
        </div>
                    ...
                    <div className="text-end">
                      {r.score !== null ? (
                        <div className="text-right">
                          ...
                          <span className="badge bg-emerald-100 text-emerald-700 text-[10px] dark:bg-emerald-500/15 dark:text-emerald-400">Graded</span>
                        </div>
                      ) : (
                        <div className="text-right">
                          <div className="text-sm font-bold text-gray-400">—</div>
                          <span className="badge bg-amber-100 text-amber-700 text-[10px] dark:bg-amber-500/15 dark:text-amber-400">Pending</span>
                        </div>
                      )}
                    </div>
                  </div>
